...
" " Minor changes by echofish (http://echofish.org)
 ...
 " syntax highlighting
 call <SID>X("Number", "88ffff", "", "none")
 call <SID>X("Constant", "e5786d", "", "none") "unmod
 call <SID>X("String", "993399", "", "italic")
 call <SID>X("Comment", "999999", "", "italic")
 call <SID>X("Identifier", "449999", "", "none")
 call <SID>X("Keyword", "85e279", "", "none")
 call <SID>X("Statement", "87afff", "", "none") "unmod
 call <SID>X("Function", "9999ff", "", "none")
 call <SID>X("PreProc", "e5786d", "", "none") "unmod
 call <SID>X("Type", "caeb82", "", "none") "unmod
 call <SID>X("Special", "ffdead", "", "none") "unmod
